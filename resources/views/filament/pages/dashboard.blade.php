<x-filament::page>
    <div class="max-w-7xl mx-auto px-6 py-10 space-y-6">
        ...
        <x-filament::card class="p-6 space-y-4 shadow-md">
            <div class="space-y-2">
                ...
                <p class="text-gray-800 dark:text-gray-300 text-base leading-relaxed">
                    ...
                    <span class="font-semibold">integral</span> y <span class="font-semibold">sin complicaciones</span>.
                </p>
            </div>
        </x-filament::card>
        ...
        <x-filament::card class="p-6 space-y-3 shadow-md">
            ...
            <div class="prose dark:prose-invert text-sm max-w-none">
                <ul class="list-disc pl-5">
                    <li>Administrá socios, empleados, actividades, ventas, facturación y más.</li>
                    <li>Organizá institutos, talleres y subactividades de forma eficiente.</li>
                    <li>Gestioná eventos y mantené actualizada la información de cada miembro.</li>
                    <li>Emití comprobantes, controlá pagos y registrá ventas con facilidad.</li>
                    <li>Llevá un seguimiento claro y ordenado del personal y sus horarios.</li>
                </ul>
                <p>
        ...
        <x-filament::card class="p-6 space-y-3 shadow-md">
            ...
            <div class="prose dark:prose-invert text-sm max-w-none ml-4">
                <ul class="list-disc list-inside space-y-1">
                    <li><strong>Simplificar lo complejo.</strong></li>
                    <li>
                        Queremos que la administración de tu club deje de ser una carga para convertirse en una ventaja.
